...
func (psdc *SDC) ConvertToCreationTimeHeader(systemTime *string) *CreationTimeHeader {
	pm := &requests.CreationTimeHeader{}

	pm.CreationTime = systemTime

	data := pm
	res := CreationTimeHeader{
...
func (psdc *SDC) ConvertToLastChangeTimeHeader(systemTime *string) *LastChangeTimeHeader {
	pm := &requests.LastChangeTimeHeader{}

	pm.LastChangeTime = systemTime

	data := pm
	res := LastChangeTimeHeader{
